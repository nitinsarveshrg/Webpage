              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="terminal-panel space-y-4">
                    ...
                    <a href={`tel:${portfolioData.personal.phone}`} className="flex items-center gap-3 text-zinc-300 hover:text-cyan-400 transition-colors group">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <a href={portfolioData.personal.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 terminal-panel hover:border-cyan-500 text-zinc-300 hover:text-cyan-400 text-xs">
                        <Linkedin size={14} />
                        <span>LINKEDIN</span>
                      </a>
                      <a href={portfolioData.personal.github} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 terminal-panel hover:border-cyan-500 text-zinc-300 hover:text-cyan-400 text-xs">
                        <Github size={14} />
                        <span>GITHUB</span>
                      </a>
                    </div>
